...
//
//        final Pin placeholder = new Pin(2018, "random body", "random title", 90.2, 80.2, "Civil", "tej20bone@gmail.com");
//
//        final Toast notLongError = Toast.makeText(getApplicationContext(), "lick my Scrote", Toast.LENGTH_SHORT);
//
...
//
//
//        Title.setText(String.valueOf(newPinLat));
//
//
//
...
//                String email = "rayanh_99@yahoo.com";
//                // Integer votes = placeholder.getVotes();
//
//
//
//                String pinID = databasePins.push().getKey();
//                Pin pin = new Pin(2018, body, title, newPinLat, newPinLng, postType, email);
//
